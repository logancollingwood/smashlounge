...
<html lang="en">
   <head>
      ...
      <script type="text/javascript"
         src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDqmaEEEbIm2Iln3ieqGdtfzVLi6AzHA1Q&sensor=true"></script>
   </head>
   <body>
      <body>
         <div class="wrapper">
                              ...
                              <div class='submit-wrapper'>
                                 <form class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                       <label class="col-md-4 control-label" for="mainChar">Main</label>
                                       <div class="col-md-6">
                                          <select id="mainChar" name="main" class="form-control">
                                          <?php
                                             if ($hasInfo) {
                  ...
                  <div class='row'>
                     ...
                     <div class='row'>
                        <div class='col-md-6 col-md-offset-3' style='padding-bottom:15px'>
                           <a class="button button-inline button-large button-success" type="submit" id="updateInfo" style="width: 100%;"><span id="loader" class="glyphicon glyphicon-refresh"></span> Save</a><br>
                        </div>
                     </div>
                     <div class='row'>
              ...
              $("#updateInfo").on("click", function(event) {
                ...
                .success(function(html) {
                  ...
                  if (html == "gif") {
                    ...
                    window.location.replace("/users/<?php echo $username; ?>");
                  }
                })
                .fail(function(html) {
                  console.log(html);
