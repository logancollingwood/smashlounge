    ...
    <svg 
                ...
                <g class="cbody">
                    ...
                    <g class="center">
                        ...
                        <!-- Core -->
                        <path class="core" fill="#BABABA" d="M1926.061,20.044c-767.991,0-1504,388-1504,388l460,1390c0,0,194.991-457.374,1044-457.374
                    ...
                    <g class="handle handle-left">
                        ...
                        <!-- Core -->
                        <path class="core" fill="#BABABA" d="M85.928,850.777c-28.94,121.041-75.969,769.477-57.881,1110.985
                    ...
                    <g class="handle handle-right">
                        ...
                        <!-- Core -->
                        <path class="core" fill="#BABABA" d="M3757.313,854.777c-29.648-121.042-637.449,760.831-637.449,760.831s133.42,592.238,159.363,695.986
                    ...
                    <g class="bodyframe bodyframe-left">
                        ...
                        <!-- Core -->
                        <path class="core" fill="#BABABA" d="M1742.061,1656.045c-111.077-187.172-185.557-195.029-260-316c-96-156-1.5-502.604-192-760
                    ...
                    <g class="bodyframe bodyframe-right">
                        ...
                        <!-- Core -->
                        <path class="core" fill="#BABABA" d="M3471.063,440.044c-348.945-233.108-748.243-92.075-920.001,140c-190.5,257.396-96,604-192,760
                    ...
                    <g class="base base-controlstick">
                        ...
                        <!-- Core -->
                        <ellipse class="core" fill="#BABABA" cx="762.022" cy="996.025" rx="463.164" ry="458.437"/>
                    </g>
                    ...
                    <g class="base base-dpad">
                        ...
                        <!-- Core -->
                        <ellipse class="core" fill="#BABABA" cx="1324.519" cy="1860.924" rx="312.248" ry="309.061"/>
                    </g>
                    ...
                    <g class="base base-buttons">
                        ...
                        <!-- Core -->
                        <ellipse class="core" fill="#BABABA" cx="3101.488" cy="996.025" rx="463.166" ry="458.437"/>
                    </g>
                </g>
